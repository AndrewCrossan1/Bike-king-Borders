...
<div class="container-md mt-5 border rounded mb-5">
    <div class="row">
        ...
        <div class="col-md-6 bg-dark p-4">
            <iframe src="/Media/Videos/bike_-_82636%20(Original).mp4" allowfullscreen="true" style="width: 100%; height: 100%;"></iframe>
        </div>
    </div>
</div>
