...
<section id="header">
    <div class="container-fluid bg-dark text-light p-5">
        <div class="jumbotron">
            <h1 class="display-5"><?php echo $PageName; ?></h1>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="/Media/Images/Carousel/dirt-road-3442651_1920.jpg" onclick="SetClickedPhotoURL(this.src, this.id)" id="ForestTrail" class="d-block w-100 img-fluid" alt="...">
            ...
            <div class="carousel-item">
                <img src="/Media/Images/Carousel/forest-path-4829591_1920.jpg" onclick="SetClickedPhotoURL(this.src, this.id)" id="WoodStroll" class="d-block w-100 img-fluid" alt="...">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <img src="/Media/Images/Carousel/mountain-2560534_1920.jpg" onclick="SetClickedPhotoURL(this.src, this.id)" id="DeadlyDrop" class="d-block w-100 img-fluid" alt="...">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <img src="/Media/Images/Carousel/trail-6404418_1920.jpg" onclick="SetClickedPhotoURL(this.src, this.id)" id="NaturalNice" class="d-block w-100 img-fluid" alt="...">
                <div class="carousel-caption d-none d-md-block">
